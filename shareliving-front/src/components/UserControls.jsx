...
const HasUserLoggedIn = () => {
  ...
  }, [setCurrentUser]); // 새로고침 시 token이 없으면 currentUser를 null로 설정

  const isUserLog = currentUser !== null;
    ...
    return (
      <div className="user-info-container">
        <div
          ...
          data-current-items={notifications.length}
        >
          {' '}
          {/** 사용자 알림 */}
          <button
            ...
            title={
              notifications.length
                ? `${notifications.length}개의 확인하지 않은 알림이 있습니다.`
                : '새 알림 없음'
            }
          >
            <svg
        ...
        <div
          className="togglers header-message-container"
          data-current-items={messages.length}
        >
          {' '}
          {/** 메시지함 */}
          <button
            type="button"
            id="btnToggleMessaage"
            className="togglers"
            title={
              messages.length
                ? `${messages.length}개의 확인하지 않은 메시지가 있습니다.`
                : '새 메시지 없음'
            }
          >
            <svg
